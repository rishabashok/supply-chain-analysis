...
col3.metric("Avg. Logistics Cost", f"₹{average_cost:,.2f}")
...
st.markdown("---")
st.markdown("📊 Dashboard developed by **Rishabh Ashok** as part of a Supply Chain Management internship project.")
